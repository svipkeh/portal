...
<head>
	...
	$(document).ready(function() {
		$("#app_type").ui_select_enums({schema: 'AppType', needDefault: false});
	});
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 运维工具--新增</h4>
			</div>
					...
					<div class="panel-body">
						<form id="form1" method="post" class="form-horizontal">
							<div class="form-group">
						    	<label class="control-label col-xs-2"><font color="red">*</font>工具类型</label>
						    	<div class="col-xs-2"><select class="form-control" id="app_type" name="app.app_type" onchange="show_target(this);"></select></div>
						  	</div>
						  	<div class="form-group">
						    	<label class="control-label col-xs-2"><font color="red">*</font>工具名称</label>
						    	<div class="col-xs-4"><input type="text" name="app.name_cn" placeholder="用于展示给用户" class="form-control"/></div>
...
<!-- 						    	<div class="col-xs-4"><input type="text" name="app.link_name" placeholder="堡垒机上程序的快捷方式名称" class="form-control"/></div> -->
...
<!-- 						  	</div> -->
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-6"><input type="text" name="app.parameter" placeholder="命令行参数" class="form-control"/></div>
