...
<head>
	...
	function form_save(){
		$.page.post({
			url : "${path}/fort/fortres/addInvoke",
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 堡垒机配置--新增</h4>
			</div>
					...
					<div class="panel-body">
						<form id="form1" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="res.fort_ip" placeholder="内网IP地址" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="res.fort_ip_wan" placeholder="外网IP地址" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-2"><input type="text" name="res.mstsc_port" class="form-control" value="3389"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-2"><input type="text" name="res.servmgr_port" class="form-control" value="45599"/></div>
