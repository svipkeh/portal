...
<head>
	...
	$(document).ready(function() {
		$("#res_type").ui_select_enums({schema: 'ResType', selectedValue: '${resource.res_type}'});
	});
	...
	function form_save(){
		$.page.post({
			url : "${path}/portal/resource/editInvoke",
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 资源管理--修改</h4>
			</div>
						...
						<form id="form1" method="post" class="form-horizontal">
							<input type="hidden" name="resource.id" value="${resource.id }"/>
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="resource.name_cn" placeholder="通常为中文，用于用户识别" class="form-control" value="${resource.name_cn }"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="resource.name" placeholder="通常为英文，资源的唯一标识，用于程序识别" class="form-control" value="${resource.name }"/></div>
							...
							<div class="form-group">
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-2"><input type="text" name="resource.ip" class="form-control" value="${resource.ip }"/></div>
						    	<div class="col-xs-4"><label id="validate_ip" class="control-label validate_label"></label></div>
						  	</div>
						  	<div class="form-group">
						    	<label class="control-label col-xs-2">备注</label>
						    	<div class="col-xs-4"><input type="text" name="resource.remark" class="form-control" value="${resource.remark }"/></div>
						  	</div>
