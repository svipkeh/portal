...
<head>
	...
	function form_save(){
		$.page.post({
			url : "${path}/sys/priv/function/saveInvoke",
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 功能--新增</h4>
			</div>
					...
					<div class="panel-body">
						<form id="form1" method="post" class="form-horizontal">
							<div class="form-group">
						    	<label class="control-label col-xs-2"><font color="red">*</font>所属菜单</label>
						    	<div class="col-xs-4">
						    		<div class="panel panel-default">
							    	...
							    	<input type="hidden" id="menu_id" name="function.menu_id"></input>
						    	</div>
						    	<div class="col-xs-4"><label id="validate_function_menu_id" class="control-label validate_label"></label></div>
						  	</div>
						  	<div class="form-group">
						    	<label class="control-label col-xs-2"><font color="red">*</font>功能名称 </label>
						    	<div class="col-xs-4"><input type="text" name="function.name" placeholder="功能名称" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-2"><input type="text" name="function.index" placeholder="排序，如：1,2,3" class="form-control"/></div>
