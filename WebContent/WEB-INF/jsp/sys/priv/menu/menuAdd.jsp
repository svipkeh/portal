...
<head>
	...
	function form_save(){
		$.page.post({
			url : "${path}/sys/priv/menu/saveInvoke",
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 菜单--新增</h4>
			</div>
					...
					<div class="panel-body">
						<form id="form1" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	...
						    	<input type="hidden" id="pid" name="menu.pid" value="0"></input>
						  	</div>
						  	<div class="form-group">
						    	<label class="control-label col-xs-2"><font color="red">*</font>菜单名称</label>
						    	<div class="col-xs-4"><input type="text" name="menu.name" placeholder="菜单名称" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="menu.url" placeholder="菜单的URL地址" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-2"><input type="text" name="menu.index" placeholder="排序，如：1,2,3" class="form-control" value="1"/></div>
