...
<head>
	...
	function form_save(){
		$.page.post({
			url : "${path}/sys/priv/role/saveInvoke",
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 角色--新增</h4>
			</div>
					...
					<div class="panel-body">
						<form id="form1" method="post" class="form-horizontal">
							<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="role.name" placeholder="角色名称" class="form-control"/></div>
