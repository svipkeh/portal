...
<head>
	...
	$(document).ready(function() {
		$("#role_ids").ui_checkbox({name: 'role_ids', data: '${roles}', val: 'id', note: 'name'});
	});
	...
	function form_save(){
		$.page.post({
			url : "${path}/sys/priv/user/saveInvoke",
...
<body>
	...
	<div class="container-fluid">
		<div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 用户--新增</h4>
			</div>
					...
					<div class="panel-body">
						<form id="form1" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4">
						    		<input type="text" name="user.name" placeholder="如：zhangsan" class="form-control"/>
						    		<span class="help-block">登录密码与用户名相同，请用户首次登录后修改密码 </span>
						    	</div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="user.name_cn" placeholder="如：张三" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="user.mail" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" name="user.mobile" class="form-control"/></div>
						    	<div class="col-xs-4"><label id="validate_user_mobile" class="control-label validate_label"></label></div>
						  	</div>
						  	<div class="form-group">
						  		<label class="control-label col-xs-2">备注</label>
						    	<div class="col-xs-4"><textarea rows="4" id="task_ips" name="user.remark" class="form-control" style="resize:none;"></textarea></div>
